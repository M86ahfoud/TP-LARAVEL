...
Route::get('/admin/produits/{produit}/modifier', [AdminProductController::class, 'edit']);

Route::put('/admin/produits/{produit}/modifier', [AdminProductController::class, 'update']);

Route::delete('/admin/produits/{id}/supprimer', [AdminProductController::class, 'destroy']);
